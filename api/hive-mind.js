...
async function getStockXData(sku, size, accessToken) {
  ...
  try {
    ...
    return {
      ...
      retailPrice: product.productAttributes?.retailPrice || null,
      size: sizeFilter,
      lowestAsk: parseFloat(marketData.lowestAskAmount) || null,
      highestBid: parseFloat(marketData.highestBidAmount) || null,
      sellFaster: parseFloat(marketData.sellFasterAmount) || null,
      earnMore: parseFloat(marketData.earnMoreAmount) || null,
      allVariants: formatVariants(variants),
    };
  } catch (err) {
